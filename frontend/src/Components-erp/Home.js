...
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, BarChart, Bar, ResponsiveContainer, PieChart, Pie, Sector, Cell, } from 'recharts';
const data = [
    {
        name: 'Page A',
        uv: 4000,
...
function Sample() {
    ...
    return (
        <>
            <div className="">
                <div className="flex">
                    <div className=" p-1 m-1 bg-blue-300  w-1/4 shadow-2xl">
                    ...
                    <div className=" p-1 m-1 bg-blue-200 w-1/4 shadow-2xl" >
                        <span className="mt-4 "><img src="/bubbles.png"
                            alt="" /></span>
                    ...
                    <div className="p-1 m-1  bg-blue-700 w-1/4 shadow-2xl">
                        <span className="mt-4"><img
                            src="/25268-8-bubbles-photo-thumb.png" alt="" /></span>
            ...
            <div className="w-full flex  h-2/3">
                ...
                <div className="w-2/3 mt-6 ml-8 " >
                    <AreaChart width={790} height={380} data={data}
